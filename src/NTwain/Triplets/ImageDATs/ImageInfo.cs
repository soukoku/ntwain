...
namespace NTwain.Triplets.ImageDATs
{
  ...
  {
    public TWRC Get(ref TW_IDENTITY_LEGACY app, ref TW_IDENTITY_LEGACY ds, out TW_IMAGEINFO data)
      => DoIt(ref app, ref ds, MSG.GET, out data);

    static TWRC DoIt(ref TW_IDENTITY_LEGACY app, ref TW_IDENTITY_LEGACY ds, MSG msg, out TW_IMAGEINFO data)
    {
      var rc = TWRC.FAILURE;
      data = default;
      ...
      else if (TwainPlatform.IsMacOSX)
      {
        ...
        {
          rc = OSXNewDSM.DSM_Entry(ref app2, ref ds2, DG.IMAGE, DAT.IMAGEINFO, msg, ref data);
        }
      }
      return rc;
    }
