...
public class ImageMemFileXfer
{
    public TWRC Get(TWIdentityWrapper app, TWIdentityWrapper ds, ref TW_IMAGEMEMXFER data)
    {
        ...
        if (TWPlatform.IsWindows)
        {
            ...
            {
                rc = WinLegacyDSM.DSM_Entry(ref app.TW_IDENTITY_LEGACY, ref ds.TW_IDENTITY_LEGACY, DG.IMAGE, DAT.IMAGEMEMFILEXFER, MSG.GET, ref data);
            }
            else
            {
                rc = WinNewDSM.DSM_Entry(ref app.TW_IDENTITY_LEGACY, ref ds.TW_IDENTITY_LEGACY, DG.IMAGE, DAT.IMAGEMEMFILEXFER, MSG.GET, ref data);
            }
        }
        return rc;
    }
