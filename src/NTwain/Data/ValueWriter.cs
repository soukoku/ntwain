...
namespace NTwain.Data
{
    ...
    public static class ValueWriter
    {
        ...
        /// <summary>
        /// Creates a <see cref="TW_CAPABILITY"/> with a one-value container.
        /// Caller will be responsible for ensuring memory is freed.
        /// </summary>
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static TW_CAPABILITY CreateOneValueCap<TValue>(this CAP cap, IMemoryManager memMgr, TValue value) where TValue : struct
        {
            TW_CAPABILITY twCap = new() { Cap = cap, ConType = TWON.ONEVALUE };
        ...
        /// <summary>
        /// Creates a <see cref="TW_CAPABILITY"/> with multiple values in an array container.
        /// Caller will be responsible for ensuring memory is freed.
        /// </summary>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="cap"></param>
        ...
        public static TW_CAPABILITY CreateArrayCap<TValue>(this CAP cap, IMemoryManager memMgr, IList<TValue> values) where TValue : struct
        {
            ...
            TW_CAPABILITY twCap = new() { Cap = cap, ConType = TWON.ARRAY };
        ...
        /// <summary>
        /// Creates a <see cref="TW_CAPABILITY"/> with multiple values in an enum container.
        /// Caller will be responsible for ensuring memory is freed.
        /// </summary>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="cap"></param>
        ...
        public static TW_CAPABILITY CreateEnumCap<TValue>(this CAP cap, IMemoryManager memMgr, Enumeration<TValue> value) where TValue : struct
        {
            if (value.Items == null) throw new ArgumentException("No items found in enumeration", nameof(value));
        ...
        /// <summary>
        /// Creates a <see cref="TW_CAPABILITY"/> with multiple values in a range container.
        /// Caller will be responsible for ensuring memory is freed.
        /// </summary>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="cap"></param>
        ...
        static TWTY GetItemType<TValue>()
        {
            var type = typeof(TValue);
            if (type == typeof(TW_BOOL)) return TWTY.BOOL;
